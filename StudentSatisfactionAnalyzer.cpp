...
private:
    void InitializeComponent() {
        ...
        instructionsLabel1->Font = gcnew Drawing::Font(instructionsLabel1->Font->FontFamily, 9, FontStyle::Bold);
        ...
        for (int i = 0; i < 20; i++) {
            ...
            factorLabels[i]->Size = Drawing::Size(labelWidth, boxHeight * 2);
            factorLabels[i]->Font = gcnew Drawing::Font(factorLabels[i]->Font->FontFamily, 9);
            ...
            factorInputs[i]->Location = Point(startX + col * (labelWidth + boxWidth + 20) + labelWidth,
                startY + row * (boxHeight + spacing));
            factorInputs[i]->Size = Drawing::Size(boxWidth, boxHeight);
        ...
        methodsGroupBox->Size = Drawing::Size(520, 220);
        ...
        instructionsLabel2->Font = gcnew Drawing::Font(instructionsLabel2->Font->FontFamily, 9, FontStyle::Bold);
        instructionsLabel2->Location = Point(60, 30);
        instructionsLabel2->Size = Drawing::Size(400, 20);
        ...
        boostedTreesButton->Location = Point(60, 60);
        boostedTreesButton->Size = Drawing::Size(180, 30);
        boostedTreesButton->Font = gcnew Drawing::Font(boostedTreesButton->Font->FontFamily, 9);
        ...
        randomForestButton->Location = Point(260, 60);
        randomForestButton->Size = Drawing::Size(180, 30);
        randomForestButton->Font = gcnew Drawing::Font(randomForestButton->Font->FontFamily, 9);
        ...
        annButton->Location = Point(60, 100);
        annButton->Size = Drawing::Size(380, 40);
        annButton->Font = gcnew Drawing::Font(annButton->Font->FontFamily, 9);
        ...
        instructionsLabel3->Font = gcnew Drawing::Font(instructionsLabel3->Font->FontFamily, 9, FontStyle::Bold);
        instructionsLabel3->Location = Point(60, 140);
        instructionsLabel3->Size = Drawing::Size(400, 40);
        ...
        allMethodsButton->Location = Point(60, 180);
        allMethodsButton->Size = Drawing::Size(380, 30);
        allMethodsButton->Font = gcnew Drawing::Font(allMethodsButton->Font->FontFamily, 9);
        ...
        satisfactionLabel->Location = Point(550, 590);
        satisfactionLabel->AutoSize = true;
        satisfactionLabel->Font = gcnew Drawing::Font(satisfactionLabel->Font->FontFamily, 9);
        ...
        satisfactionOutput->Location = Point(750, 590);
        satisfactionOutput->Size = Drawing::Size(350, 30);
        ...
        resultsGroupBox->Size = Drawing::Size(570, 220);
        ...
        array<String^>^ methodNames = {
            L"Boosted Trees:",
            L"Random Forest:",
            L"Искусственная нейронная сеть (ANN)\nс архитектурой MLP 20-17-3:"
        };
        ...
        for (int i = 0; i < 3; i++) {
            ...
            methodLabels[i]->Size = Drawing::Size(250, 40);
            methodLabels[i]->Font = gcnew Drawing::Font(methodLabels[i]->Font->FontFamily, 9);
            ...
            satisfactionOutputs[i]->Location = Point(270, i * 50);
            satisfactionOutputs[i]->Size = Drawing::Size(270, 30);
        ...
        clearButton->Location = Point(10, 175);
        clearButton->Size = Drawing::Size(550, 30);
        clearButton->Font = gcnew Drawing::Font(clearButton->Font->FontFamily, 10);
